...
if __name__ == "__main__":
    ...
    for data_type in data_type_list:
        ...
        if 'woconv' in data_type:
            pred_score = np.load('./pred_act/pred_act_score_woconv.npy')
        if 'woconv-history' in data_type:
            pred_score = np.load('./pred_act/pred_act_score_woconv-history.npy')
