...
if __name__ == "__main__":
    ...
    data_type_list = ['_all_seq','_all_seq2','_all_seq3','_woconv_seq','_woconv_seq2','_woconv_seq3','_woconv-history','_woconv-history2','_woconv-history3']
    ...
    for data_type in data_type_list:
        ...
        for fp_llm in fname_llm:
            ...
            rel_top1_llm.append(rel_llm[order_llm[0]])
            rel_top3_llm.append(np.sum(rel_llm[order_llm[0:3]]))
            rel_top5_llm.append(np.sum(rel_llm[order_llm[0:5]]))
            ...
            for i in range(order_traj.shape[1]):
                ...
                if i >= d1: 
                    ...
                    rel_top1_traj[0].append(rel_traj[order_traj[0,i],i])
                    rel_top3_traj[0].append(np.sum(rel_traj[order_traj[0:3,i],i]))
                    rel_top5_traj[0].append(np.sum(rel_traj[order_traj[0:5,i],i]))
                    rel_top1_ours[0].append(rel_ours[order_ours[0,i],i])
                    rel_top3_ours[0].append(np.sum(rel_ours[order_ours[0:3,i],i]))
                    rel_top5_ours[0].append(np.sum(rel_ours[order_ours[0:5,i],i]))
                ...
                if i >= d2:
                    ...
                    rel_top1_traj[1].append(rel_traj[order_traj[0,i],i])
                    rel_top3_traj[1].append(np.sum(rel_traj[order_traj[0:3,i],i]))
                    rel_top5_traj[1].append(np.sum(rel_traj[order_traj[0:5,i],i]))
                    rel_top1_ours[1].append(rel_ours[order_ours[0,i],i])
                    rel_top3_ours[1].append(np.sum(rel_ours[order_ours[0:3,i],i]))
                    rel_top5_ours[1].append(np.sum(rel_ours[order_ours[0:5,i],i]))
                ...
                if i >= d3:
                    ...
                    rel_top1_traj[2].append(rel_traj[order_traj[0,i],i])
                    rel_top3_traj[2].append(np.sum(rel_traj[order_traj[0:3,i],i]))
                    rel_top5_traj[2].append(np.sum(rel_traj[order_traj[0:5,i],i]))
                    rel_top1_ours[2].append(rel_ours[order_ours[0,i],i])
                    rel_top3_ours[2].append(np.sum(rel_ours[order_ours[0:3,i],i]))
                    rel_top5_ours[2].append(np.sum(rel_ours[order_ours[0:5,i],i]))
        ...
        np.savetxt(folder_path_eval + "res_eval_pct.csv", out_pct, delimiter=',', fmt='%s')
        np.savetxt(folder_path_eval + "res_eval_pct_all.csv", out_pct_all, delimiter=',', fmt='%s')
